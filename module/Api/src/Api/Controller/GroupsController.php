...
class GroupsController extends AbstractApiController
{
     ...
     *             description="The email address for this group.",
     *             paramType="form",
     *             type="string",
     *             required=false
     *         ),
     ...
     *         ),
     *         @SWG\Parameter(
     *             name="config[useMailingList]",
     *             description="Whether to use the configured email address or expand individual members addresses.",
     *             paramType="form",
     *             type="boolean",
     *             required=false
     *         )
    ...
    public function patch($id, $data)
    {
        ...
        $data   = $this->flattenGroupInput($data);
        $data   = $this->filterOutQuotation($data, array('Users', 'Owners', 'Subgroups'));
    ...
    protected function flattenGroupInput($data)
    {
        if (isset($data['config'])) {
            $data += array_intersect_key(
                $data['config'],
                array_flip(array('name', 'description', 'emailFlags', 'emailAddress', 'useMailingList'))
            );
            unset($data['config']);
        }
