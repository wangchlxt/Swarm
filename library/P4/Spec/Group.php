 ...
 * - "groups" output is unusually formatted; see Plural Abstract for details
 *
...
class Group extends PluralAbstract
{
    ...
    // Constants to use for FETCH_BY_USER_MODE
    const USER_MODE_USER  = 'user';
    const USER_MODE_OWNER = 'owner';
    const USER_MODE_ALL   = 'all';
    ...
    const FETCH_BY_USER_MODE    = 'fetchByUserMode';
