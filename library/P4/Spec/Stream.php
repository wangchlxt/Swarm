...
class Stream extends PluralAbstract
{
     ...
     *  SORT_RECURSIVE - optionally sort the results recursively
     *
    ...
    /**
     * Get the parent associated with this stream in Stream format.
     *
    ...
    public function getParentObject()
    {
        ...
        if (!isset($this->cache['parentObject'])
            ...
            $this->cache['parentObject'] = Stream::fetchById(
                $this->getParent(),
                $this->getConnection()
            );
        }
     ...
     * Paths are passed as an array of path entries. Each path entry can be an array with
     ...
     * stream first.
     *
     * @param   array       $params     pass array('-f') to force delete this stream, additionally
