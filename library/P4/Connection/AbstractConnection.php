...
abstract class AbstractConnection implements ConnectionInterface
{
    ...
    private static $CACHED_TIME_ZONE = null;
    ...
    public function batchArgs(array $arguments, array $prefixArgs = null, array $suffixArgs = null, $groupSize = 1)
    {
        ...
        while (!empty($arguments)) {
            ...
            // this informs the caller of indivisible args and avoids infinite loops
     ...
     *
     * @param  useCache     allow cached timezone to be used
     * @return DateTimeZone the server's timezone
     * @throws \Exception   if the server's timezone isn't parsable
     */
    public function getTimeZone($useCache = true)
    {
        if (null === AbstractConnection::$CACHED_TIME_ZONE || !$useCache) {
            ...
            if (isset($info['serverDate'])
                ...
                AbstractConnection::$CACHED_TIME_ZONE = Time::toDateTimeZone($timezone['name'], $timezone['offset']);
            } else {
        ...
        return AbstractConnection::$CACHED_TIME_ZONE;
    }
